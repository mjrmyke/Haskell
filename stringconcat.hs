--Myke Walker Lab 0 CSCI 60

-- lab0.hs
-- CSci 60, Lab 0
-- The purpose of this lab is to make sure that everyone knows how to
...
-- to get you started. Here, as in all following labs, your task is to
...
empty :: [a] -> Bool
empty as = if mylen as == 0 then True
                           else False
